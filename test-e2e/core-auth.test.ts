    ...
    describe('Core routing with real HTTP requests', () => {
        ...
        it('should handle POST requests and validate body.', async () => {
            ...
            routes.post({
                ...
                handler: async (context: ApienceRequestContext<{ name: string }>): Promise<{
                    id: string;
                    name: string
                }> => {
    ...
    describe('PUT/PATCH requests', () => {
        it('should handle PUT requests for full updates.', async () => {
            ...
            routes.put({
                ...
                handler: async (context: ApienceRequestContext<{ name: string; description?: string }>): Promise<{
                    id: string;
                    name: string;
                    description: string
                }> => {
    ...
    describe('OpenAPI documentation generation', () => {
        ...
        it('should document request and response bodies in OpenAPI schema.', async () => {
            ...
            routes.post({
                ...
                handler: async (context: ApienceRequestContext<{ title: string; tags?: string[] }>): Promise<{
                    id: string;
                    title: string
                }> => {
